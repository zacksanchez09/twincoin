...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.twincoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.twincointools.com", true);
        vSeeds.emplace_back("dnsseed.twincoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.twincointools.com", true);
        vSeeds.emplace_back("seed-b.twincoin.loshan.co.uk", true);
