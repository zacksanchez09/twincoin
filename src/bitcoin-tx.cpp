...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s twincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  twincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded twincoin transaction") + "\n" +
              "  twincoin-tx [options] -create [commands]   " + _("Create hex-encoded twincoin transaction") + "\n" +
              "\n";
