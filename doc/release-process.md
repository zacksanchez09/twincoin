...
* Update manpages, see [gen-manpages.sh](https://github.com/interflexia/twincoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [twincoin-detached-sigs](https://github.com/interflexia/twincoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/interflexia/twincoin/releases/new) with a link to the archived release notes.
