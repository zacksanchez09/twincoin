...
Twincoin Core version *0.15.0* is now available from:
  ...
  <https://download.faithco.in/twincoin-0.15.0/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/interflexia/twincoin/issues>
...
- #21349 `fa625b0` Document CWalletTx::mapValue entries and remove erase of nonexistent "version" entry (ryanofsky)
